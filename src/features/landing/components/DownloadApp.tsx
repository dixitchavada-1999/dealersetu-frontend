...
import { PILL_TEAL, GRADIENT_TEXT } from '../data';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center">
            <div className="relative">
              <div className="absolute -inset-8 rounded-[3.5rem] blur-2xl" style={{ background: 'rgba(15, 82, 186, 0.2)' }} />
              <div className="relative w-64 h-[520px] bg-black rounded-[3rem] p-3 shadow-2xl border-4 border-black">
                <div className="w-full h-full rounded-[2.3rem] overflow-hidden flex flex-col" style={{ backgroundColor: '#0f172a' }}>
                  <div className="h-14 flex items-center justify-center text-white font-semibold" style={{ background: 'linear-gradient(135deg, #0F52BA 0%, #3B82F6 100%)' }}>DealerSetu</div>
                  <div className="flex-1 p-4 space-y-3 overflow-hidden">
                    {['Orders', 'Products', 'Customers', 'Dispatch', 'Marketing'].map(k => (
                      <div key={k} className="backdrop-blur p-3 rounded-xl border" style={{ backgroundColor: 'rgba(15, 82, 186, 0.08)', borderColor: 'rgba(15, 82, 186, 0.2)' }}>
