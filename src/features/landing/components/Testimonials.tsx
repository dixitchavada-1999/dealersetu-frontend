    ...
    <section className="py-8 lg:py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <h2 className="text-4xl sm:text-5xl font-bold text-slate-900">Loved by businesses</h2>
          <p className="mt-6 text-lg" style={{ color: '#475569' }}>Don't just take our word for it.</p>
        </div>

        <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
          {testimonials.map(t => (
            <div key={t.name} className="p-8 rounded-2xl bg-white border border-slate-200 shadow-sm transition hover:border-teal-400/40">
